...
public class ProductValidator {
    ...
    public boolean isValidated(Product product) throws ProductNameEmptyException, ProductWeightNoPositiveException, ProductCountNegativeException, ProductPriceNoPositiveException {
